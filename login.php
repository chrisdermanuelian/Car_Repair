<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT CUST_ID FROM CUSTOMER WHERE CUST_EMAIL = '$myusername' and CUST_PASSWORD = '$mypassword'";
      $result = mysqli_query($connection,$sql);
      $row = mysqli_fetch_array($result, MYSQLI_ASSOC);
      printf ("%s", $row["CUST_ID"]);
      $active = $row['active'];
      ...
      if($count == 1) {
         ...
         $_SESSION['cur_user_id'] = $row["CUST_ID"];
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        ...
                                        <div>Sign up if you don't have an account!</div>
                                    </div>
                                </div>
                            </div>
                        </div>
